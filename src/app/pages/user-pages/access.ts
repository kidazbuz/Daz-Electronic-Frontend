...
@Component({
    selector: 'app-access',
    standalone: true,
    imports: [ButtonModule, RouterModule, Copyright, RippleModule, AppFloatingConfigurator, ButtonModule],
                    ...
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-8 px-4 sm:px-10 flex flex-col items-center" style="border-radius: 53px">
                        <div class="gap-4 flex flex-col items-center">
                            ...
                            <div class="col-span-12 mt-8 text-center">
                                <p-button label="Go to Dashboard" routerLink="/dashboard/main" severity="warn" />
                            </div>
                        </div>
                    </div>
                </div>
